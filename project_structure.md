...
### D:\Darshan\Projects\My Portfolio\README.md
...
### D:\Darshan\Projects\My Portfolio\backend\data\portfolio_data.json
  ...
  "aboutTraits": [
    {
      "emoji": "ðŸŽ¨",
      "label": "Creative",
      "description": "Clay, paint & digital art â€” design thinking runs deep."
    },
    {
      "emoji": "ðŸ§ ",
      "label": "Strategic",
...
### D:\Darshan\Projects\My Portfolio\backend\routes\information.py
...
const Title = styled.h3`
  ...
  /* truncate to 2 lines with ellipsis â€” works on all content lengths */
  display: -webkit-box;
  -webkit-line-clamp: 1;
  -webkit-box-orient: vertical;
  overflow: hidden;
...
// CSS `animation: rotate()` on the same element every frame â€” killing the spin,
// and the spin's rotate() overwrote the translate â€” killing the parallax.
//
// Fix: two-layer DOM structure.
//   â€¢ ShapeEl (outer div) â†’ RAF writes translate(x,y)   â€” parallax only
//   â€¢ SpinEl  (inner div) â†’ CSS animation rotate()      â€” spin only
...
/* â”€â”€â”€ Touch detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const IS_TOUCH =
  typeof window !== 'undefined' &&
  window.matchMedia('(pointer: coarse)').matches;

/* â”€â”€â”€ Keyframe â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const spinSlow = keyframes`
  from { transform: rotate(0deg); }
  to   { transform: rotate(360deg); }
`;

/* â”€â”€â”€ Styled components â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */

/**
 * OUTER wrapper â€” RAF writes translate(x, y) here for parallax.
...
const ShapeEl = styled.div`
  ...
  will-change: transform;   /* GPU layer always ready â€” safe because it's already composited */
`;

/**
 * INNER wrapper â€” CSS animation rotate() lives here exclusively.
...
/* â”€â”€â”€ Shape data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const shapes = [
  {
    svg: (
...
const FloatingShapes = ({
  ...
  /* â”€â”€ Desktop mouse parallax â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  useEffect(() => {
  ...
  /* â”€â”€ Gyroscope (mobile gyro mode only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  useEffect(() => {
    ...
    const onTouchStart = () => {
      if (typeof DeviceOrientationEvent?.requestPermission === 'function') {
        DeviceOrientationEvent.requestPermission()
          ...
          .catch(() => { /* denied â€” silently stays as spin */ });
      } else {
  ...
  /* â”€â”€ RAF spring loop â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  useEffect(() => {
    if (!needsRAF) return;
    ...
    const tick = () => {
      ...
      shapes.forEach((shape, i) => {
        ...
        if (Math.abs(velocity[i].x) > 0.001 || Math.abs(velocity[i].y) > 0.001) {
          // Writes ONLY to ShapeEl (outer). SpinEl (inner) is untouched â†’ spin preserved.
...
// 1. Removed will-change:transform from Wave SVG elements â€” will-change only accelerates
...
// 2. Added mobile RAF throttle â€” runs at 30fps on touch devices instead of 60fps.
...
// will-change removed â€” SVG path 'd' changes are NOT accelerated by will-change:transform
...
function buildWavePath(amp, phase, freq, baseline = 40, height = 80) {
  const W   = 1440;
  const pts = IS_TOUCH ? 50 : 80; // fewer points on mobile â€” visually identical
...
const WaterWaves = () => {
  ...
  useEffect(() => {
    ...
    // Mobile: no touch input for waves â€” they just animate autonomously
  }, []);
...
// mode="wait" exits old page fully before mounting new one â€” one page in DOM at a time.
...
### D:\Darshan\Projects\My Portfolio\frontend\my_portfolio\src\components\ui\AdminCardSkeleton.jsx
...
### D:\Darshan\Projects\My Portfolio\frontend\my_portfolio\src\components\ui\EmptyState.jsx
 ...
 * Props
 * â”€â”€â”€â”€â”€
 * icon     string   emoji or character shown large   default "ðŸ“­"
...
```
// ============================================================
// siteData.js â€” Single source of truth for all portfolio data
// Darshan Agrawal | Full Stack Engineer
// Icons: react-icons/si â€” import { SiReact } from 'react-icons/si'
// ============================================================
...
export const personalInfo = {
  ...
  bio: "Full Stack Engineer with 4+ years building performant, data-driven web apps. I specialize in React ecosystems and Python backends â€” from real-time KPI dashboards to automated data pipelines â€” with a sharp eye for clean code and intuitive design.",
  email: 'darshanagrawal007@gmail.com',
  location: 'India (Remote Worldwide)',
  resumeUrl: '/resume.pdf',
  socials: {
...
// â”€â”€ About Traits (flip cards) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Filter Categories (Case Studies page) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const openEdit = (item) => {
    ...
    schemas[tab].forEach(({ name }) => {
      if (BOOLEAN_FIELDS.has(name)) {
        // Coerce to boolean â€” handles 0/1, "true"/"false", null, undefined from API
          ...
          <GridWrap>
            <CardGrid>
              {loading ? (
                ...
                <EmptyStateWrap>
                  <EmptyState
                    icon={tab === "blogs" ? "ðŸ“" : tab === "cases" ? "ðŸ“" : "ðŸ’¬"}
                    title={`No ${tab} yet`}
                    message={
                      tab === "messages"
                      ...
                      <CardBody>
                          {(tab === "blogs" || tab === "cases") && (
                            <>
                              <ChipsRow>
                                {(() => {
                                  const categories = (item.category || "â€”")
                                    .split(",")
                                    .map(cat => cat.trim())
                                    .filter(Boolean);
...
const ChipsRow = styled.div`
  display: flex;
  flex-wrap: nowrap;      /* no wrap â€” chips stay on one line */
  gap: 4px;
  margin-bottom: 6px;
...
### D:\Darshan\Projects\My Portfolio\frontend\my_portfolio\src\styles\globalStyles.jsx
...
const darkColors = {
  // â”€â”€ Backgrounds â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  bgPrimary:            '#0D0F14',
  bgSecondary:          '#12141A',
  bgTertiary:           '#181B23',
  ...
  // â”€â”€ Accent â€“ Navy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  accentNavy:           '#1E3A5F',
  accentNavyLight:      '#2A5A8F',

  // â”€â”€ Accent â€“ Pink / Gradient â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Accent â€“ Blue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  accentBlue:           '#3B82F6',
  ...
  // â”€â”€ Accent â€“ Green â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  accentGreen:          '#00E89D',
  accentGreenGlow:      'rgba(0, 232, 157, 0.25)',

  // â”€â”€ Accent â€“ Coral / Crimson / Danger â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  accentCoral:          '#FF6B4A',
  ...
  // â”€â”€ Surfaces (alpha whites for glass / inactive elements) â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Shadows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Pre / Code block â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  preBg:                'rgba(0, 0, 0, 0.40)',        // <pre> background in preview

  // â”€â”€ Gradients â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Decorative â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const lightColors = {
  ...
  // â”€â”€ Surfaces â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const CATEGORY_MAP = {
  dark: {
    ...
    // â”€â”€ Case Study â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// mode comes from theme.mode â€” 'dark' | 'light'
