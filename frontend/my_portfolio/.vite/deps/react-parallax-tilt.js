...
import { t as require_jsx_runtime } from "./jsx-runtime-Bu8lCzEX.js";
...
var s = class {
	constructor(t, e) {
		this.glareAngle = 0, this.glareOpacity = 0, this.calculateGlareSize = (t) => {
			...
			const { xPercentage: i, yPercentage: n } = t, s = 180 / Math.PI;
			this.glareAngle = (i ? Math.atan2(n, -i) * s : 0) - (e ? 180 : 0);
