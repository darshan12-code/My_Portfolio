...
function v(t) {
	...
	return new Error(y.apply(void 0, __spreadArray([m[t]], n, !1)).trim());
}
var g = 1 << 30, S = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), b = 1, N = function(e) {
...
}, C = /invalid hook call/i, A = /* @__PURE__ */ new Set(), _ = function(t, n) {
	...
	try {
		...
		console.error = function(t) {
			for (var n = [], o = 1; o < arguments.length; o++) n[o - 1] = arguments[o];
			C.test(t) ? (a = !1, A.delete(s)) : i.apply(void 0, __spreadArray([t], n, !1));
		}, "function" == typeof import_react.useState && import_react.useState(null), a && !A.has(s) && (console.warn(s), A.add(s));
	} catch (e) {
...
var we = function(e) {
	...
	function e(e, n, o) {
		...
		var r = this;
		this.options = __assign(__assign({}, Ae), e), this.gs = n, this.names = new Map(o), this.server = !!e.isServer, !this.server && h && Ce && (Ce = !1, ge(this)), le(this, function() {
			return function(e) {
...
function Te(e) {
	...
	p.push(function(e) {
		e.type === RULESET && e.value.includes("&") && (o || (o = new RegExp("\\".concat(n, "\\b"), "g")), e.props[0] = e.props[0].replace(Pe, n).replace(o, l));
	}), a.prefix && p.push(prefixer), p.push(stringify);
	var h = [], d = middleware(p.concat(rulesheet(function(e) {
		return h.push(e);
	}))), f = function(e, r, i, c) {
		...
		}(e)), l = compile(i || r ? "".concat(i, " ").concat(r, " { ").concat(u, " }") : u);
		return a.namespace && (l = Re(l, a.namespace)), h = [], serialize(l, d), h;
	};
	return f.hash = u.length ? u.reduce(function(e, t) {
		return t.name || v(15), F(e, t.name);
	}, 5381).toString() : "", f;
}
var xe = new _e(), je = Te(), ke = import_react.createContext({
	shouldForwardProp: void 0,
	styleSheet: xe,
	stylis: je
}), Me = ke.Consumer, Ve = import_react.createContext(void 0);
function Fe() {
	return import_react.useContext(ke);
}
function Ge(e) {
	if (!import_react.useMemo) return e.children;
	var t = Fe().styleSheet, n = import_react.useMemo(function() {
		var n = t;
		...
		e.target,
		t
	]), r = import_react.useMemo(function() {
		return Te({
			options: {
	...
	return import_react.createElement(ke.Provider, { value: s }, import_react.createElement(Ve.Provider, { value: r }, e.children));
}
var Le = function() {
	function e(e, t) {
		var n = this;
...
var Ye = function(e) {
	...
	for (var o in t) {
		var r = t[o];
		t.hasOwnProperty(o) && !Ye(r) && (Array.isArray(r) && r.isCss || re(r) ? n.push("".concat($e(o), ":"), r, ";") : ce(r) ? n.push.apply(n, __spreadArray(__spreadArray(["".concat(o, " {")], We(r), !1), ["}"], !1)) : n.push("".concat($e(o), ": ").concat(Be(o, r), ";")));
	}
	return n;
};
function qe(e, t, n, o, r) {
	...
	if (re(e)) {
		...
		var s = e(t);
		return "object" != typeof s || Array.isArray(s) || s instanceof Le || ce(s) || null === s || console.error("".concat(B(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), qe(s, t, n, o, r);
	}
	var i;
...
var Ue = G(l), Je = function() {
	function e(e, t, n) {
		this.rules = e, this.staticRulesId = "", this.isStatic = false, this.componentId = t, this.baseHash = F(Ue, t), this.baseStyle = n, _e.registerId(t);
	}
	return e.prototype.generateAndInjectStyles = function(e, t, n) {
		...
		if (this.isStatic && !n.hash) if (this.staticRulesId && t.hasNameForId(this.componentId, this.staticRulesId)) o = ie(o, this.staticRulesId);
			...
			for (var a = F(this.baseHash, n.hash), c = "", u = 0; u < this.rules.length; u++) {
				var l = this.rules[u];
				if ("string" == typeof l) c += l, a = F(a, l);
				else if (l) {
					var p = ae(qe(l, e, t, n));
...
}(), Xe = import_react.createContext(void 0), Ze = Xe.Consumer;
function Ke() {
	var e = import_react.useContext(Xe);
	if (!e) throw v(18);
	return e;
}
function Qe(e) {
	var n = import_react.useContext(Xe), r = import_react.useMemo(function() {
		return function(e, n) {
			if (!e) throw v(14);
			if (re(e)) {
				var o = e(n);
				if (null === o || Array.isArray(o) || "object" != typeof o) throw v(7);
				return o;
			}
	...
	return e.children ? import_react.createElement(Xe.Provider, { value: r }, e.children) : null;
}
var et = {}, tt = /* @__PURE__ */ new Set();
function nt(e, s, i) {
	...
	function E(e, s) {
		return function(e, s, i) {
			var a = e.attrs, c = e.componentStyle, u = e.defaultProps, l = e.foldedComponentIds, p = e.styledComponentId, h = e.target, d = import_react.useContext(Xe), f = Fe(), m = e.shouldForwardProp || f.shouldForwardProp;
			import_react.useDebugValue && import_react.useDebugValue(p);
			var y = O(s, d, u) || I, v = function(e, n, o) {
				for (var r, s = __assign(__assign({}, n), {
					...
					for (var c in a) "className" === c ? s.className = ie(s.className, a[c]) : "style" === c ? s.style = __assign(__assign({}, s.style), a[c]) : s[c] = a[c];
				}
				return "className" in n && "string" == typeof n.className && (s.className = ie(s.className, n.className)), s;
			}(a, s, y), g = v.as || h, S = {};
			for (var w in v) void 0 === v[w] || "$" === w[0] || "as" === w || "theme" === w && v.theme === y || ("forwardedAs" === w ? S.as = v.forwardedAs : m && !m(w, g) || (S[w] = v[w], m || n(w) || tt.has(w) || !D.has(g) || (tt.add(w), console.warn("styled-components: it looks like an unknown prop \"".concat(w, "\" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)")))));
			var N = function(e, t) {
				var n = Fe(), r = e.generateAndInjectStyles(t, n.styleSheet, n.stylis);
				return import_react.useDebugValue && import_react.useDebugValue(r.className), r;
			}(c, v).className;
			e.warnTooManyClasses && e.warnTooManyClasses(N);
			var E = ie(l, p);
			return N && (E += " " + N), v.className && (E += " " + v.className), S[z(g) && !D.has(g) ? "class" : "className"] = E, i && (S.ref = i), (0, import_react.createElement)(g, S);
		}(C, e, s);
	}
	E.displayName = y;
	var C = import_react.forwardRef(E);
	...
	}), _(y, v), C.warnTooManyClasses = function(e, t) {
		var n = {}, o = !1;
		return function(r) {
...
function st(t) {
	for (var n = [], o = 1; o < arguments.length; o++) n[o - 1] = arguments[o];
	if (re(t) || ce(t)) return rt(qe(ot(P, __spreadArray([t], n, !0))));
	var r = t;
...
function it(n, o, r) {
	...
	var s = function(t) {
		...
		return n(o, r, st.apply(void 0, __spreadArray([t], s, !1)));
	};
	return s.attrs = function(e) {
		return it(n, o, __assign(__assign({}, r), { attrs: Array.prototype.concat(r.attrs, e).filter(Boolean) }));
	}, s.withConfig = function(e) {
		return it(n, o, __assign(__assign({}, r), e));
	}, s;
}
var at = function(e) {
	return it(nt, e);
...
function lt(n) {
	...
	var i = st.apply(void 0, __spreadArray([n], r, !1)), a = "sc-global-".concat(L(JSON.stringify(i))), c = new ut(i, a);
	_(a);
	var u = /* @__PURE__ */ new WeakMap(), l = function(e) {
		var t = Fe(), n = import_react.useContext(Xe), r = u.get(t.styleSheet);
		return void 0 === r && (r = t.styleSheet.allocateGSInstance(a), u.set(t.styleSheet, r)), import_react.Children.count(e.children) && console.warn("The global style component ".concat(a, " was given child JSX. createGlobalStyle does not render children.")), i.some(function(e) {
			return "string" == typeof e && -1 !== e.indexOf("@import");
		}) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), ("undefined" == typeof window || !t.styleSheet.server) && p(r, e, t.styleSheet, n, t.stylis), import_react.useLayoutEffect(function() {
			return t.styleSheet.server || p(r, e, t.styleSheet, n, t.stylis), function() {
				var e;
				c.removeStyles(r, t.styleSheet), e = t.styleSheet.options.target, "undefined" != typeof document && (null != e ? e : document).querySelectorAll("style[data-styled-global=\"".concat(a, "\"]")).forEach(function(e) {
					return e.remove();
				});
			};
		}, [
	...
	function p(e, n, o, r, s) {
		if (c.isStatic) c.renderStyles(e, f, o, s);
			...
			var i = __assign(__assign({}, n), { theme: O(n, r, l.defaultProps) });
			c.renderStyles(e, i, o, s);
		}
	}
	return import_react.memo(l);
}
function pt(t) {
	for (var n = [], o = 1; o < arguments.length; o++) n[o - 1] = arguments[o];
	"undefined" != typeof navigator && "ReactNative" === navigator.product && console.warn("`keyframes` cannot be used on ReactNative, only on the web. To do animation in ReactNative please use Animated.");
	var r = ae(st.apply(void 0, __spreadArray([t], n, !1)));
	return new Le(L(r), r);
}
function ht(e) {
	var n = import_react.forwardRef(function(n, r) {
		var s = O(n, import_react.useContext(Xe), e.defaultProps);
		return void 0 === s && console.warn("[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class \"".concat(B(e), "\"")), import_react.createElement(e, __assign(__assign({}, n), {
			theme: s,
			ref: r
		}));
	});
...
var dt = function() {
	function e() {
		...
		this._emitSheetCSS = function() {
			...
			if (!r) return [];
			var s = ((n = {})[a] = "", n[u] = l, n.dangerouslySetInnerHTML = { __html: r }, n), i = Se();
			return i && (s.nonce = i), [import_react.createElement("style", __assign({}, s, { key: "sc-0-0" }))];
		}, this.seal = function() {
			e.sealed = !0;
		}, this.instance = new _e({ isServer: !0 }), this.sealed = !1;
	}
	return e.prototype.collectStyles = function(e) {
		if (this.sealed) throw v(2);
		return import_react.createElement(Ge, { sheet: this.instance }, e);
...
//#endregion
export { dt as ServerStyleSheet, Me as StyleSheetConsumer, ke as StyleSheetContext, Ge as StyleSheetManager, Ze as ThemeConsumer, Xe as ThemeContext, Qe as ThemeProvider, ft as __PRIVATE__, lt as createGlobalStyle, st as css, ct as default, ct as styled, se as isStyledComponent, pt as keyframes, Ke as useTheme, l as version, ht as withTheme };
